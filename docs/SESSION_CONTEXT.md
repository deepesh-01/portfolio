...
>
> **Last updated:** 2026-05-09, at end of **The Institutional Resilience** session
> (Phase 10 — Late 2025 — landed live; the post-Bloom chapter where Founding Logic carried the rescues).
...
- **Case studies are now at 12** (Christmas SQL, 175-Lead Bug, Ghost Sprint, 150GB Migration, Flask-to-Node Fallback, SQL Optimisation 15m→75s, Zoca Unified Migration, $6M Lambda Swarm, PSQL Audit Function, Master-Worker Architecture, Win Agent Testing, Infra-Flip 5-Minute RCA). The cap kept moving with the work. Past 12, the home-page list is approaching brochure-length — retire an older one before adding. Likely candidate for retirement: 175-Lead Bug (least transferable-lesson-shaped of the twelve).
