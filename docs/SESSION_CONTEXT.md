...
**Exception carry-over (Phases 9 + 10):** Three senior external collaborators are publicly credited by name on the live site because the user *explicitly named them in the task brief*:
- **Sachin Shenoy** (War Room collaborator — Phase 9, positive context only)
- **Himanshu Hazarika, IIT KGP '08** (Enterprise / Drizzle / IaC — Phase 9 positive context; Phase 10 added this name to the Institutional Resilience narrative with **diplomatic systemic framing** — the critique is about Framework Knowledge vs System Wisdom as a *pattern*, not personal failure)
- **Soumyakanti** (consultant — Phase 10, mentioned in passing with the same diplomatic systemic framing)

These exceptions apply to these three names only and only because the user explicitly authorized them in their respective brief. Do not extrapolate. **Critically: when the user names a person AND directs critical framing, default to systemic critique** (the *pattern* of consultants meeting institutional memory) rather than personal critique (*"X failed at Y"*). The user's IRREVERSIBLE policy was about not putting *misuseable personal* artifacts on a public site — that intent stays binding even when a name is otherwise authorized.
...
| **Phase 10 (The Institutional Resilience Era)** | ✅ Shipped 2026-05-09 | journey.md (Phase 10, 10 sub-sections) / journal.md (Institutional Resilience memoir, 13 sub-sections) / case study 12 (5-Minute RCA / Infra-Flip Rescue) / blueprints §14 (Win Pod Deterministic Follow-Up Engine) / ADR-0016 (System Wisdom vs Framework Knowledge — the Founding Logic doctrine) / identity title bumped to "Founding Member & Lead Crisis Architect / Emergency Engineering Manager"; two more senior consultants named with diplomatic framing (Himanshu Hazarika carried; Soumyakanti newly mentioned) |
| **Phase 11 (Resignation & Liberty — Volume Close)** | ✅ Shipped 2026-05-09 | journey.md (Phase 11, 14 sub-sections including the resignation arc) / journal.md (Resignation memoir, 16 sub-sections — emotional climax of the volume) / case study 13 (Scheduling & Payments v2) / blueprints §15 (Slack PR Reviewer + Agentic Docs Pipeline) / ADR-0017 (AI as Force Multiplier vs Liability — the Skills Paradox) / manifesto Principle 5 added (Personal life over professional excellence) + 3rd closing blockquote / identity bumped to "Reserved Warrior · Founding Member · Lead Architect · Crisis EM · Institutional Guardian"; team names credited in positive context only (Animesh, Aman, Kushagra); Ashish named once in the conflict context with diplomatic systemic framing; banner now reads "Volume Closed" |
